 ...
 * @version $Id$
 */
public class PropsFirstPropertyUtilsBean extends QPropertyUtilsBean {
	...
	/**
	 * Note: this is a *very rough* override of this method. In particular, it
	 * does not handle MAPPED_DELIM and INDEXED_DELIM chars in the propertyName,
	 * so propertyNames like "a(b)" or "a[3]" will not be correctly handled.
	 */
	@Override
