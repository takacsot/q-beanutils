...
public class TestBean implements Serializable {
  ...
  /**
   * An "indexed property" accessible via both array and subscript based
   * getters and setters.
   */
   ...
   */
  List<Object> listIndexed = new ArrayList<Object>();
  ...
  private String[][] string2dArray = new String[][] { new String[] { "1", "2", "3" },
      new String[] { "4", "5", "6" } };
