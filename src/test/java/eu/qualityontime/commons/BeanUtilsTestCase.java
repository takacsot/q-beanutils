...
/**
 * <p>
 * Test Case for the BeanUtils class. The majority of these tests use instances
 * of the TestBean class, so be sure to update the tests if you change the
 ...
 *
 * <p>
 * Note that the tests are dependant upon the static aspects (such as array
 * sizes...) of the TestBean.java class, so ensure than all changes to TestBean
 * are reflected here.
 * </p>
 *
 * <p>
...
public class BeanUtilsTestCase extends TestCase {
	 ...
	 */
	protected String describes[] = { "booleanProperty", "booleanSecond", "byteProperty", "doubleProperty",
			"dupProperty", "floatProperty", "intArray",
			// "intIndexed",
	 ...
	 */
	public void _testCopyPropertiesStandard() {
	 ...
	 */
	public void _testGetArrayProperty() {
		try {
	 ...
	 */
	public void _testGetArrayPropertyDate() {
		String[] value = null;
		try {
	 ...
	 */
	public void _testGetIndexedProperty1() {
		try {
	 ...
	 * Test <code>getArrayProperty()</code> converting to a String.
	 */
	public void _testGetIndexedPropertyDate() {
		String value = null;
		try {
			bean.setDateArrayProperty(new java.util.Date[] { testUtilDate });
	 ...
	 * tests getting an indexed property
	 */
	public void _testGetIndexedProperty2() {
		try {
			String val = BeanUtils.getIndexedProperty(bean, "intIndexed", 3);
			String comp = String.valueOf(bean.getIntIndexed(3));
	 ...
	 */
	public void _testGetNestedProperty() {
		try {
	 ...
	 */
	public void _testGetGeneralProperty() {
		try {
	 ...
	 * tests getting a 'whatever' property
	 */
	public void _testGetSimpleProperty() {
		try {
	 ...
	 */
	public void _testGetSimplePropertyDate() {
		String value = null;
		try {
	 ...
	 */
	public void _testPopulateArrayElements() {
	 ...
	 */
	public void _testPopulateArrayProperties() {
	 ...
	 */
	public void _testPopulateMapped() {
	 ...
	 */
	public void _testPopulateNested() {
		...
		try {
			...
			assertEquals("stringProperty is \"This is a string\"", "This is a string",
					bean.getNested().getStringProperty());
			assertEquals("writeOnlyProperty is \"New writeOnlyProperty value\"", "New writeOnlyProperty value",
	 ...
	 */
	public void _testPopulateScalar() {
		...
		try {
			...
			assertEquals("readOnlyProperty is \"Read Only String Property\"", "Read Only String Property",
	 ...
	 */
	public void _testSetPropertyNullValues() throws Exception {
	 ...
	 */
	public void _testSetPropertyOnPrimitiveWrappers() throws Exception {
	 ...
	 */
	public void _testSetPropertyByte() throws Exception {

		BeanUtils.setProperty(bean, "byteProperty", new Byte((byte) 123));
		assertEquals((byte) 123, bean.getByteProperty());
		/*
		 * BeanUtils.setProperty(bean, "byteProperty", new Double((double)
		 * 123)); assertEquals((byte) 123, bean.getByteProperty());
	 ...
	 */
	public void _testSetPropertyConvert() {
		try {
	 ...
	 */
	public void _testSetPropertyConvertFromString() {
		try {
	 ...
	 */
	public void _testSetPropertyConvertToString() {
		try {
	 ...
	 */
	public void _testSetPropertyConvertToStringArray() {
		try {
	...
	/**
	 * Test <code>setProperty()</code> converting to a String on indexed
	 * property
	 */
	public void _testSetPropertyConvertToStringIndexed() {
		try {
	 ...
	 */
	public void _testSetPropertyDouble() throws Exception {
	 ...
	 */
	public void _testSetPropertyFloat() throws Exception {
	 ...
	 */
	public void _testSetPropertyInteger() throws Exception {

		BeanUtils.setProperty(bean, "longProperty", new Byte((byte) 123));
		assertEquals(123, bean.getIntProperty());
		/*
		 * BeanUtils.setProperty(bean, "longProperty", new Double((double)
		 * 123)); assertEquals((int) 123, bean.getIntProperty());
	 ...
	 */
	public void _testSetPropertyLong() throws Exception {

		BeanUtils.setProperty(bean, "longProperty", new Byte((byte) 123));
		assertEquals(123, bean.getLongProperty());
		/*
		 * BeanUtils.setProperty(bean, "longProperty", new Double((double)
		 * 123)); assertEquals((long) 123, bean.getLongProperty());
		 * BeanUtils.setProperty(bean, "longProperty", new Float((float) 123));
	 ...
	 */
	public void _testSetPropertyNull() throws Exception {
	 ...
	 */
	public void _testSetPropertyShort() throws Exception {

		BeanUtils.setProperty(bean, "shortProperty", new Byte((byte) 123));
		assertEquals((short) 123, bean.getShortProperty());
		/*
		 * BeanUtils.setProperty(bean, "shortProperty", new Double((double)
		 * 123)); assertEquals((short) 123, bean.getShortProperty());
	 ...
	 */
	public void _testSetPropertyStringToArray() throws Exception {
	 ...
	 * Test narrowing and widening conversions on byte.
	 */
	public void _testCopyPropertyByte() throws Exception {
	 ...
	 */
	public void _testCopyPropertyConvert() {
		try {
	 ...
	 */
	public void _testCopyPropertyConvertFromString() {
		try {
	 ...
	 */
	public void _testCopyPropertyConvertToString() {
		try {
	 ...
	 * Test <code>copyProperty()</code> converting to a String.
	 */
	public void _testCopyPropertyConvertToStringArray() {
		try {
			bean.setStringArray(null);
	...
	/**
	 * Test <code>copyProperty()</code> converting to a String on indexed
	 * property
	 */
	public void _testCopyPropertyConvertToStringIndexed() {
		try {
			bean.setStringArray(new String[1]);
	 ...
	 * Test narrowing and widening conversions on double.
	 */
	public void _testCopyPropertyDouble() throws Exception {
	 ...
	 * Test narrowing and widening conversions on float.
	 */
	public void _testCopyPropertyFloat() throws Exception {
	 ...
	 * Test narrowing and widening conversions on int.
	 */
	public void _testCopyPropertyInteger() throws Exception {
	 ...
	 * Test narrowing and widening conversions on long.
	 */
	public void _testCopyPropertyLong() throws Exception {
	 ...
	 * Test narrowing and widening conversions on short.
	 */
	public void _testCopyPropertyShort() throws Exception {
	...
	/**
	 * Test copying a property using a nested indexed array expression, with and
	 * without conversions.
	 */
	public void _testCopyPropertyNestedIndexedArray() throws Exception {
	 ...
	 */
	public void _testCopyPropertyNestedMappedMap() throws Exception {
	 ...
	 * without conversions.
	 */
	public void _testCopyPropertyNestedSimple() throws Exception {
	 ...
	 */
	public void _testCopyPropertyNull() throws Exception {
	 ...
	 * conversions.
	 */
	public void _testCopyPropertyWriteOnly() throws Exception {
	 ...
	 * conversions.
	 */
	public void _testSetPropertyWriteOnly() throws Exception {
	...
	public void _testSeparateInstances() throws Exception {
		final BeanUtilsBean utilsOne = new BeanUtilsBean(new ConvertUtilsBean(),
				new org.apache.commons.beanutils.PropertyUtilsBean());
		final BeanUtilsBean utilsTwo = new BeanUtilsBean(new ConvertUtilsBean(),
				new org.apache.commons.beanutils.PropertyUtilsBean());
	...
	public void _testArrayPropertyConversion() throws Exception {
		final BeanUtilsBean beanUtils = new BeanUtilsBean(new ConvertUtilsBean(),
				new org.apache.commons.beanutils.PropertyUtilsBean());
	...
	public void _testMappedProperty() throws Exception {
	...
	/**
	 * Catch a cause, initialize using BeanUtils.initCause() and throw new
	 * exception
	 */
