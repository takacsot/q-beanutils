 ...
 * instances of the TestBean class, so be sure to update the tests if you change
...
public class PropertyUtilsTestCase extends TestCase {
   ...
   * <code>getPropertyDescriptors()</code>. You should update this list when
   * new properties are added to TestBean.
   */
  protected final static String[] properties = { "booleanProperty", "booleanSecond", "doubleProperty", "dupProperty",
      "floatProperty", "intArray", "intIndexed", "intProperty", "listIndexed", "longProperty", "nested",
      "nullProperty", "readOnlyProperty", "shortProperty", "stringArray", "stringIndexed", "stringProperty",
      "writeOnlyProperty", };
  ...
  /**
   * <p>
   * Negative tests on an invalid property with two different boolean getters
   * (which is fine, according to the JavaBeans spec) but a String setter
   * instead of a boolean setter.
   * </p>
   *
   * <p>
   * Although one could logically argue that this combination of method
   * signatures should not identify a property at all, there is a sentence in
   * Section 8.3.1 making it clear that the behavior tested for here is
   * correct: "If we find only one of these methods, then we regard it as
   * defining either a read-only or write-only property called
   * <em>&lt;property-name&gt;</em>.
   * </p>
   */
  ...
  public void testGetDescriptorMappedPeriods() {
    ...
    assertEquals("Can retrieve directly", testIntegerValue,
    ...
    try {
      ...
      assertEquals("Check descriptor type (A)", Integer.TYPE,
  ...
  /**
   * Positive getPropertyDescriptor on property <code>readOnlyProperty</code>.
   */
  ...
  /**
   * Positive test for getPropertyDescriptors(). Each property name listed in
  ...
  public void testGetIndexedArguments() {
    ...
    try {
      propertyUtils._getIndexedProperty(bean, "[0]");
  ...
  public void testGetIndexedValues_field() {
  ...
  public void testGetMappedPeriods() {
    ...
    try {
      assertEquals("Can retrieve via getMappedProperty", "Special Value",
          propertyUtils.getMappedProperty(bean, "mappedProperty", "key.with.a.dot"));
    } catch (final Exception e) {
      fail("Thew exception: " + e);
    }
    try {
      assertEquals("Can retrieve via getNestedProperty", "Special Value",
    ...
    try {
      assertEquals("Can retrieve nested", "This is a string",
  ...
  public void testGetMappedValues_field() {

    Object value = null;

    //enforce mapped to generate
    Objects.CONST(bean.getMappedProperty("foo"));
    // Use explicit key argument
  ...
  public void testGetNestedBoolean_field() {
    bean.getNested();
    {
      final Object value = propertyUtils.getNestedProperty(bean, "@nested.booleanProperty");
      assertNotNull("Got a value", value);
  ...
  public void testGetNestedDouble() {
    ...
    assertEquals("Got correct value", ((Double) value).doubleValue(), bean.getNested().getDoubleProperty(),
        0.005);
  ...
  public void testGetNestedFloat() {
    ...
    assertEquals("Got correct value", ((Float) value).floatValue(), bean.getNested().getFloatProperty(),
        (float) 0.005);
  ...
  public void testGetNestedUnknown_field() {
    bean.getNested();
    try {
      propertyUtils.getNestedProperty(bean, "@nested.@unknown");
      fail("Should have thrown NoSuchMethodException");
  ...
  /**
   * When a bean has a null property which is reference by the standard access
   * language, this should throw a NestedNullException.
   */
  ...
  public void testThrowNestedNull_field() throws Exception {
    final NestedTestBean nestedBean = new NestedTestBean("base");
    // don't init!
    try {
      propertyUtils.getProperty(nestedBean, "@simpleBean.indexedProperty[0]");
      fail("NestedNullException not thrown");
    } catch (final NestedNullException e) {
      // that's what we wanted!
    }
  ...
  /**
   * Test getting accessible property reader methods for a specified list of
   * properties of our standard test bean.
   */
  ...
  /**
   * Test getting accessible property reader methods for a specified list of
   * properties of a package private subclass of our standard test bean.
   */
  ...
  /**
   * Test getting accessible property reader methods for a specified list of
   * properties that are declared either directly or via implemented
   * interfaces.
   */
  ...
  /**
   * Test getting accessible property reader methods for a specified list of
   * properties of a public subclass of our standard test bean.
   */
  ...
  public void testGetSimpleBoolean_field() throws Exception {
    final Object value = propertyUtils.getSimpleProperty(bean, "@booleanProperty");
    assertNotNull("Got a value", value);
    assertTrue("Got correct type", value instanceof Boolean);
    assertTrue("Got correct value", ((Boolean) value).booleanValue() == bean.getBooleanProperty());
  ...
  public void testGetSimpleDouble_field() {
  ...
  public void testGetSimpleNested_field() {
  ...
  public void testGetSimpleReadOnly_field() {
  ...
  public void testGetSimpleUnknown_field() {
  ...
  /**
   * Test getting accessible property writer methods for a specified list of
   * properties of our standard test bean.
   */
  ...
  public void testSetIndexedArguments() {
    ...
    try {
      propertyUtils._setIndexedProperty(bean, "[0]", new Integer(1));
      fail("Should throw NoSuchMethodException 4");
    } catch (final NoSuchMethodException e) {
      // Expected response
    } catch (final Throwable t) {
    ...
    try {
      propertyUtils._setIndexedProperty(bean, "intIndexed", new Integer(1));
      fail("Should throw IllegalArgumentException 5");
    } catch (final IllegalArgumentException e) {
      // Expected response
    } catch (final Throwable t) {
  ...
  public void testSetIndexedValues_field() {
  ...
  public void testSetMappedArguments() {
    ...
    try {
      propertyUtils._setMappedProperty(bean, "(Second Key)", "Second Value");
      fail("Should throw IllegalArgumentException 5");
    } catch (final NoSuchMethodException e) {
      // Expected response
    } catch (final Throwable t) {
  ...
  public void testSetMappedValues() {
    ...
    try {
      propertyUtils.setMappedProperty(bean, "@mappedProperty(Fifth Key)", null);
    } catch (final Throwable t) {
      fail("Setting fifth value threw " + t);
    }
    try {
  ...
  public void testSetMappedPeriods() {
    ...
    try {
      ...
      assertEquals("Check set via setMappedProperty", "Updated Special Value",
    ...
    try {
      ...
      assertEquals("Check set via setNestedProperty (B)", "Updated Special Value",
          bean.getMappedProperty("key.with.a.dot"));
    } catch (final Exception e) {
      fail("Thew exception: " + e);
    }
  ...
  public void testSetNestedReadOnly() throws Exception {
    ...
    try {
      ...
      propertyUtils._setNestedProperty(bean, "nested.readOnlyProperty", newValue);
      fail("Should have thrown NoSuchMethodException");
    } catch (final NoSuchMethodException e) {
  ...
  public void testSetSimpleNested() throws Exception {
    ...
    try {
      propertyUtils._setSimpleProperty(bean, "nested.stringProperty", "New String Value");
      fail("Should have thrown IllegalArgumentException");
    } catch (final IllegalArgumentException e) {
      // Correct result for this test
    }
  ...
  public void testSetSimpleReadOnly() throws Exception {
    ...
    try {
      ...
      final String newValue = oldValue + " Extra Value";
      propertyUtils._setSimpleProperty(bean, "readOnlyProperty", newValue);
      fail("Should have thrown NoSuchMethodException");
    } catch (final NoSuchMethodException e) {
      // Correct result for this test
      assertEquals("Property 'readOnlyProperty' has no setter method in class '" + bean.getClass() + "'",
          e.getMessage());
    }
  ...
  public void testSetSimpleUnknown() throws Exception {
    ...
    try {
      final String newValue = "New String Value";
      propertyUtils._setSimpleProperty(bean, "unknown", newValue);
      fail("Should have thrown NoSuchMethodException");
    } catch (final NoSuchMethodException e) {
      // Correct result for this test
   ...
   *
   * @param bean
   *            Bean for which to retrieve read methods.
   * @param properties
   *            Property names to search for
   * @param className
   *            Class name where this method should be defined
   */
   ...
   *
   * @param bean
   *            Bean for which to retrieve write methods.
   * @param properties
   *            Property names to search for
   * @param className
   *            Class name where this method should be defined
  ...
  public void testNestedWithIndex() throws Exception {
    ...
    assertEquals("Cannot set property on indexed property on property", "Test#3",
  ...
  /**
   * There is an issue in setNestedProperty/getNestedProperty when the target
   * bean is a map and the name string requests mapped or indexed operations
   * on a field. These are not supported for fields of a Map, but it's an easy
   * mistake to make and this test case ensures that an appropriate exception
   * is thrown when a user does this.
   * <p>
   * The problem is with passing strings of form "a(b)" or "a[3]" to
   * setNestedProperty or getNestedProperty when the target bean they are
   * applied to implements Map. These strings are actually requesting "the
   * result of calling mapped method a on the target object with a parameter
   * of b" or "the result of calling indexed method a on the target object
   * with a parameter of 3". And these requests are not valid when the target
   * is a Map as a Map only supports calling get(fieldName) or put(fieldName),
   * neither of which can be further indexed with a string or an integer.
   * <p>
  ...
  /**
   * Returns a single string containing all the keys in the map, sorted in
   * alphabetical order and separated by ", ".
   * <p>
   ...
   * <p>
   * Note that this behaviour has changed several times over past releases of
   * beanutils, breaking backwards compatibility each time. Here's hoping that
   * the current 1.7.1 release is the last time this behaviour changes!
   */
  public void testMapExtensionDefault() throws Exception {
    ...
    assertEquals("Set nested property on map unexpected affected simple property", "new value",
        bean.getUnusuallyNamedProperty());
  }

  /**
   * This tests to see that it is possible to subclass PropertyUtilsBean and
   * change the behaviour of setNestedProperty/getNestedProperty when dealing
   * with objects that implement Map.
   */
  public void testMapExtensionCustom() throws Exception {
    ...
    assertEquals("setNestedProperty on non-simple property failed", "next value",
    ...
    assertEquals("setNestedProperty on non-simple property failed", "value1",
        utilsBean.getNestedProperty(bean, "mapProperty"));
  ...
  /**
   * Test {@link PropertyUtilsBean}'s invoke method throwing an
   * IllegalArgumentException and check that the "cause" has been properly
   * initialized for JDK 1.4+ See BEANUTILS-266 for changes and reason for
   * test
   */
  ...
  /**
   * Tests whether a reset of the registered BeanIntrospectors can be
   * performed.
   */
