 ...
 * </p>
 * <p>
 * This class is used by {@link QPropertyUtilsBean}. When accessing bean
...
class BeanIntrospectionData {
	 ...
	 * setting the map with write method names. This constructor is mainly used
	 ...
	 * specified name. If this property is unknown, result is <b>null</b>.
	 *
	 * @param name
	 ...
	 * descriptor object itself. However, at least by the ORACLE implementation,
	 * the method is stored as a {@code SoftReference}. If this reference has
	 * been freed by the GC, it may be the case that the method cannot be
	 * obtained again. Then, additional information stored in this object is
	 * necessary to obtain the method again.
	 *
	 * @param beanCls
