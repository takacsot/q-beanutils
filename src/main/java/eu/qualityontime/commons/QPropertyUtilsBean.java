...
public class QPropertyUtilsBean {
   ...
   *
   * @param introspector
   *            the <code>BeanIntrospector</code> to be added (must not be
   *            <b>null</b>
  ...
  public void _copyProperties(final Object dest, final Object orig)
      throws Exception {
  ...
  public Object _getIndexedProperty(final Object bean, final String name, final int index)
      throws Exception {
   ...
   *
   * @throws IllegalAccessException
   *             just in case subclasses override this method to try to access
  ...
  public void _setIndexedProperty(final Object bean, String name, final Object value)
      throws Exception {
  ...
  public void _setIndexedProperty(final Object bean, final String name, final int index, final Object value)
      throws Exception {
  ...
  public void _setMappedProperty(final Object bean, String name, final Object value)
      throws Exception {
  ...
  public void _setNestedProperty(Object bean, String name, final Object value)
      throws Exception {
  ...
  public void _setSimpleProperty(final Object bean, final String name, final Object value)
      throws Exception {
